...
#list of cells to plot is second argument from command line
cells_to_plot_string=sys.argv[2].split(',')
print(cells_to_plot_string)
cells_to_plot = [int(i) for i in cells_to_plot_string]
