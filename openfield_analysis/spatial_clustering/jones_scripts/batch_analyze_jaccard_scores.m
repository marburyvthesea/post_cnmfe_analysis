...
dataDirectory = '/Volumes/My_Passport/cnmfe_analysis_files/OpenFieldAnalysis/2020/D1_mGluRKO_clustering/data/ko/' ; 
...
for session = 1:size_array(1,1);
	...
	sessionOutput = jaccard_compute_fn_jjm(dataDirectory, KO_sessions{session, :}, 2.5, 2.5, 500, 20);
